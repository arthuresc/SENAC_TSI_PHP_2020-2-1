...
if ( isset($_SESSION['login']) ) { //Caso o usuário já esteja logado no sistema
	...
	$r = $db->query("SELECT senha FROM usuario WHERE email = '$login'"); //senha é uma PK para pegar da tabela usuário o email que for igual ao colocado no form de login e que entrou aqui na variavel $login
